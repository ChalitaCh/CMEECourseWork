...
parameters <- read.csv("../data/Fitted_parameters.csv")
data_raw <- read.csv("../data/GrowthDataClean.csv")
...
names <- c("ID", "GomAICc", "LogAICc", "Qua_AICc", "Cubic_AICc","MinValue","Weight_Model","normal_prob")

model_AIC_final <- model_AIC_final[,names]
